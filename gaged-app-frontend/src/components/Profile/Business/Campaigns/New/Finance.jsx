                  ...
                  <div className="mt-3 border-t-2 border-gray-400 md:w-3/4 lg:w-4/6">
                    <div className="py-4 text-base">
                      <div className="md:w-11/12 lg:w-5/6 leading-5">
                        You need Link valid bank account to set up your
                      ...
                      <div className="leading-5 mt-1">
                        You may be required to verify your account before you
                        are enabled to initiate withdrawals. This verification
                        will be done as soon as Link bank account account is
                        added.
                      </div>
                    </div>
                  </div>
