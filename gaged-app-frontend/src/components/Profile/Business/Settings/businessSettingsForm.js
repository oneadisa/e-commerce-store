...
const BusinessSettingsForm = () => {
  ...
  const [totalNumberOfCampaignsStarted, settotalNumberOfCampaignsStarted] =
    useState("");
  const [totalNumberOfCampaignsInvested, settotalNumberOfCampaignsInvested] =
    useState("");
  ...
  const [numberOfBusinessInvestors, setnumberOfBusinessInvestors] =
    useState("");
  const [listOfBusinessInvestors, setlistOfBusinessInvestors] = useState("");
  const [numberOfIndividualInvestors, setnumberOfIndividualInvestors] =
    useState("");
  const [listOfIndividualInvestors, setlistOfIndividualInvestors] =
    useState("");
  ...
  const [numberOfIndividualReviews, setnumberOfIndividualReviews] =
    useState("");
  ...
  const [numberOfIndividualCustomers, setnumberOfIndividualCustomers] =
    useState("");
  const [businessCustomers, setbusinessCustomers] = useState("");
  const [numberOfBusinessCustomers, setnumberOfBusinessCustomers] =
    useState("");
  ...
  const [totallNumberOfInteractions, settotallNumberOfInteractions] =
    useState("");
  ...
  useEffect(() => {
    if (businessInfo) {
      ...
      setlistOfCampaignsStarted(businessInfo.listOfCampaignsStarted);
      setlistOfCampaignsInvested(businessInfo.listOfCampaignsInvested);
      settotalAmountRaised(businessInfo.totalAmountRaised);
      setaverageRaised(businessInfo.averageRaised);
      setnumberOfBusinessInvestors(businessInfo.numberOfBusinessInvestors);
      setlistOfBusinessInvestors(businessInfo.listOfBusinessInvestors);
      setnumberOfIndividualInvestors(businessInfo.numberOfIndividualInvestors);
      setlistOfIndividualInvestors(businessInfo.listOfIndividualInvestors);
      settotalNumberOfInvestors(businessInfo.totalNumberOfInvestors);
      ...
      setnumberOfStoreProducts(businessInfo.numberOfStoreProducts);
      setdeliveryCharge(businessInfo.deliveryCharge);
      settotalRevenue(businessInfo.totalRevenue);
      settotalProductNumber(businessInfo.totalProductNumber);
      setbusinessOrderedFrom(businessInfo.businessOrderedFrom);
      setnumberOfOrderRequests(businessInfo.numberOfOrderRequests);
      setquantityOfOrders(businessInfo.quantityOfOrders);
      setindividualReviews(businessInfo.individualReviews);
      setnumberOfIndividualReviews(businessInfo.numberOfIndividualReviews);
      setbusinessReviews(businessInfo.businessReviews);
      setnumberOfBusinessReviews(businessInfo.numberOfBusinessReviews);
      settotalNumberOfReviews(businessInfo.totalNumberOfReviews);
      setbusinessOrders(businessInfo.businessOrders);
      setnumberOFBusinessOrders(businessInfo.numberOFBusinessOrders);
      setindividualOrders(businessInfo.individualOrders);
      setnumberOfIndividualOrders(businessInfo.numberOfIndividualOrders);
      settotalNumberOfOrders(businessInfo.totalNumberOfOrders);
      setindividualCustomers(businessInfo.individualCustomers);
      setnumberOfIndividualCustomers(businessInfo.numberOfIndividualCustomers);
      setbusinessCustomers(businessInfo.businessCustomers);
      setnumberOfBusinessCustomers(businessInfo.numberOfBusinessCustomers);
      settotalNumberOfCustomers(businessInfo.totalNumberOfCustomers);
      setcampaignReviews(businessInfo.campaignReviews);
      setnumberOfCampaignsReviwed(businessInfo.numberOfCampaignsReviwed);
      setnewnewProductReview(businessInfo.newnewProductReview);
      setnumberOfProductsReviewed(businessInfo.numberOfProductsReviewed);
      settotallNumberOfInteractions(businessInfo.totallNumberOfInteractions);
  ...
  const updateProfileSubmitHandler = (e) => {
    ...
    myForm.set("totalNumberOfCampaignsStarted", totalNumberOfCampaignsStarted);
    myForm.set(
      "totalNumberOfCampaignsInvested",
      totalNumberOfCampaignsInvested
    );
    myForm.set("listOfCampaignsStarted", listOfCampaignsStarted);
    myForm.set("listOfCampaignsInvested", listOfCampaignsInvested);
    myForm.set("totalAmountRaised", totalAmountRaised);
    myForm.set("averageRaised", averageRaised);
    myForm.set("numberOfBusinessInvestors", numberOfBusinessInvestors);
    myForm.set("listOfBusinessInvestors", listOfBusinessInvestors);
    myForm.set("numberOfIndividualInvestors", numberOfIndividualInvestors);
    myForm.set("listOfIndividualInvestors", listOfIndividualInvestors);
    myForm.set("totalNumberOfInvestors", totalNumberOfInvestors);
    myForm.set("walletBalance", walletBalance);
    myForm.set("totalSales", totalSales);
    myForm.set("storeProducts", storeProducts);
    myForm.set("numberOfStoreProducts", numberOfStoreProducts);
    ...
    myForm.set("numberOfOrderRequests", numberOfOrderRequests);
    myForm.set("quantityOfOrders", quantityOfOrders);
    myForm.set("individualReviews", individualReviews);
    myForm.set("numberOfIndividualReviews", numberOfIndividualReviews);
    myForm.set("businessReviews", businessReviews);
    myForm.set("numberOfBusinessReviews", numberOfBusinessReviews);
    myForm.set("totalNumberOfReviews", totalNumberOfReviews);
    myForm.set("businessOrders", businessOrders);
    myForm.set("numberOFBusinessOrders", numberOFBusinessOrders);
    myForm.set("individualOrders", individualOrders);
    myForm.set("numberOfIndividualOrders", numberOfIndividualOrders);
    myForm.set("totalNumberOfOrders", totalNumberOfOrders);
    myForm.set("individualCustomers", individualCustomers);
    myForm.set("numberOfIndividualCustomers", numberOfIndividualCustomers);
    myForm.set("businessCustomers", businessCustomers);
    myForm.set("numberOfBusinessCustomers", numberOfBusinessCustomers);
    myForm.set("totalNumberOfCustomers", totalNumberOfCustomers);
    myForm.set("campaignReviews", campaignReviews);
    myForm.set("numberOfCampaignsReviwed", numberOfCampaignsReviwed);
    myForm.set("newnewProductReview", newnewProductReview);
    myForm.set("numberOfProductsReviewed", numberOfProductsReviewed);
    myForm.set("totallNumberOfInteractions", totallNumberOfInteractions);
    ...
    case 3:
      return (
        <SettingsStore
          ...
          storeLogo={storeLogo}
          setstoreBackground={setstoreBackground}
