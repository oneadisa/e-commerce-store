...
function ProductsNew() {
  ...
  //   productCredentials.price = productCredentials.subPrice + productCredentials.shippingCost;
  ...
  const createProductSubmitHandler = (e) => {
    ...
    myForm.set("price", productCredentials.price);
                ...
                <div className="grid grid-rows-1 gap-5 lg:gap-0 lg:grid-cols-3 mt-4">
                  <div className="flex">
                    ...
                    <input
                      onChange={handlechange}
                      name="shippingCost"
                      value={signedUpBusinessInfo.shippingCost}
                      placeholder={signedUpBusinessInfo.shippingCost}
