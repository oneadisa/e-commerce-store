...
function ProductsNew() {
    ...
    return ( <
        ...
        /div> {
            error && ( <
                GeneralErrorMessage bg = "danger" > { businessError } <
                /GeneralErrorMessage>
            )
        ...
        Publish product <
        /h4> { /* <div className="border-t-2 px-3 pt-3"> */ } { /* <p className="text-lg font-normal text-Dark-grey mb-3"> */ } { /* Product status */ } { /* </p> */ } { /* <div className="pb-5 flex gap-3"> */ } { /* <Switch */ } { /* // checked={enabled} */ } { /* // onChange={setEnabled} */ } { /* // className={`block bg-gray-400 rounded-full shadow border-2 border-transparent h-6 w-12 transition duration-200 ${ */ } { /* // enabled ? "" : "justify-end bg-Dark-blue" */ } { /* // }`} */ } { /* // > */ } { /* <span className="block h-full w-6 rounded-full bg-white" /> */ } { /* </Switch> */ } { /* <div> */ } { /* <p className="text-lg font-normal text-Dark-grey mb-3"> */ } { /* Draft */ } { /* </p> */ } { /* </div> */ } { /* </div> */ } <
        /div> <
        div className = "flex justify-between mt-4" > { /* <button className="border py-2 px-2 text-Dark-blue hover:bg-Dark-blue hover:text-white "> */ } { /* Preview */ } { /* </button> */ } <
        button onClick = { createProductSubmitHandler }
