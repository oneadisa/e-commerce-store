        ...
        <div className='mx-auto'>
            ...
            <div className='lg:bg-magenta-blue lg:px-4'>
                <div className='block lg:flex lg:space-x-32'>
                    <ul className={"w-2/3 lg:w-32 min-h-screen lg:min-h-0 absolute transition duration-200 bg-magenta-blue text-Dark-grey lg:static flex flex-col text-lg font-medium lg:mt-10 lg:block" + ( open === true ? ' ' : ' hidden ' ) }>
                    ...
                    <div className='flex flex-col bg-white lg:my-10 lg:space-y-10 lg:w-4/5 lg:h-2/5'>
                        <div className='px-1 md:px-2'>
                            <div className='flex justify-between py-5 md:px-2'>
                                <h2 className='text-lg md:text-2xl font-semibold'>Alleyway Security Fundraiser</h2>
                                    ...
                                    <div className='flex flex-col md:flex-row gap-10 md:gap-5 lg:gap-5'>
                                        ...
                                        <div className='flex flex-col w-full gap-2'>
                                            <div className='flex flex-col border-2'>
                                                ...
                                                <div className='border-t-2 justisfy-items-center text-center items-center'>
                                                    <div className='flex flex-col gap-4 lg:gap-4 py-4 pb-4 lg:py-9 w-full'>
                                                        <h4 className='text-lg font-medium'>DONATION</h4>
                                    ...
                                    <div className='pt-2'>
                                        <div className='lg:px-1'>
                                            <div className='text-base text-gray-500 font-normal py-3 leading-6 md:w-3/4 lg:w-1/2'>
                                                The improved security measures at Wychurst are estimated to cost £20,000. Any extra The improved
                                                security measures at Wychurst are estimated to cost £20,000The improved security measures at Wychurst
...
export default OverviewDonation
