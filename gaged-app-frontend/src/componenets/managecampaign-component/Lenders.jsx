                                                ...
                                                <div className='flex gap-2 pb-2'>
                                                    ...
                                                    <div className='flex flex-col mt-2'>
                                                        <div className='flex gap-2'>
                                                            <h3 className='text-base font-medium'>John Smith</h3>
                                                            <div className='text-Dark-blue text-base font-medium'>amount</div>
                                                        </div>
                                                        <p className='text-sm font-normal'>2 August, 2021 at 8:00am</p>
                                                    </div>
                                                </div>
