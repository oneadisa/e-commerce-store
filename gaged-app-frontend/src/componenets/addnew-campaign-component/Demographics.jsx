                ...
                <div className="block lg:flex lg:space-x-32">
                    ...
                    <div className="bg-white lg:mt-3 lg:mb-8 pb-24 lg:w-3/4">
                        <div className='flex flex-col px-2 md:px-4 py-2'>
                            ...
                            <div className='mt-3'>
                                <h2 className='text-lg font-semibold'>Tell us a bit about your customers</h2>
                                <div className='py-5 mt-3 border-t-2 border-b-2 border-gray-400 md:w-3/4 lg:w-3/5'>
                                    <h3 className='text-lg font-semibold'>Who are your ideal target audience?</h3>
                                ...
                                <div className='py-5 border-b-2 border-gray-400 md:w-3/4 lg:w-3/5'>
                                    <h3 className='text-lg font-semibold'>Health issues or disabilities</h3>
                                    <div className='my-4 grid grid-cols-2 gap-y-4 lg:w-4/6'>
                                        <div className='flex gap-2 items-center'>
                                            <input type='checkbox' className='h-7 w-7' />
                                            <div className='text-sm font-medium'>Physical disabilities</div>
                                        </div>
                                        <div className='flex gap-2 items-center'>
                                            <input type='checkbox' className='h-7 w-7' />
                                            <div className='text-sm font-medium'>Addiction issues</div>
                                        </div>
                                        <div className='flex gap-2 items-center w-full'>
                                            <input type='checkbox' className='h-7 w-7' />
                                            <div className='text-sm font-medium'>Cognitive or learning disabilities</div>
                                        </div>
                                    </div>
                                </div>
                                <div className='py-5 border-b-2 border-gray-400 md:w-3/4 lg:w-3/5'>
