                ...
                <div className="block lg:flex lg:space-x-32">
                    ...
                    <div className="bg-white lg:mt-3 lg:mb-8 pb-24 lg:w-3/4">
                        <div className='flex flex-col px-2 md:px-4 py-2'>
                            ...
                            <div className='mt-3'>
                                <h2 className='text-lg font-semibold'>What type of funding are you looking for?</h2>
                                <div className='mt-3 border-t-2 border-b-2 border-gray-400 md:w-3/4 lg:w-4/6'>
                                    <div className='pt-5 pb-7 flex flex-col gap-5 md:flex-row justify-between'>
                                        <div className='flex gap-5 items-center px-2 w-full md:w-56 h-12 bg-Dark-blue border-2 border-Dark-blue'>
                                            <div className='text-white font-medium text-lg ml-auto pl-6'>Loan</div>
                                            <div className='bg-white h-4 w-4 text-center text-Dark-blue text-xs font-medium rounded-full ml-auto'>?</div>
                                        </div>
                                        <div className='flex gap-5 items-center px-2 w-full md:w-56 h-12 bg-white border-2 border-gray-400'>
                                            <div className='text-gray-500 font-medium text-lg ml-auto pl-6'>Equity</div>
                                            <div className='bg-gray-500 h-4 w-4 text-center text-white text-xs font-medium rounded-full ml-auto'>?</div>
                                        </div>
                                    </div>
                                </div>
                                <div className='pt-5 pb-10 border-b-2 border-gray-400 md:w-3/4 lg:w-4/6'>
                                    ...
                                    <div className='pl-1 mt-2 flex flex-col gap-8 '>
                                        <p className='text-sm text-gray-800 md:4/5 lg:w-3/4'>
                                            Please click the question mark icon associated with each category to know the requirements.
                                        </p>
                                ...
                                <div className='flex flex-col gap-4 pt-2 pb-10 border-b-2 border-gray-400 md:w-3/4 lg:w-4/6'>
                                    <div className='flex flex-col gap-2 py-2'>
                                        ...
                                        <div className='pl-1 flex flex-col gap-3'>
                                            <p className='text-sm text-gray-800 md:4/5 lg:w-3/4'>Please indicate the specific amount being raised</p>
                                            <input className='border-2 border-gray-400 w-56 h-10 outline-none' />
                                        </div>
                                    </div>
                                    <div className='flex flex-col gap-2 py-2'>
                                        <h3 className='text-lg font-semibold'>Pledge profit to Lenders</h3>
                                        <div className='pl-1 flex flex-col gap-3'>
                                            <p className='text-sm text-gray-800 md:4/5 lg:w-3/4'>Please indicate the share of your profit Lenders get</p>
                                            <input className='border-2 border-gray-400 w-56 h-10 outline-none' />
                                        </div>
                                    </div>
                                    <div className='flex flex-col gap-2 py-2'>
                                        ...
                                        <div className='pl-1 flex flex-col gap-3'>
                                            <p className='text-sm text-gray-800 md:4/5 lg:w-3/4'>Please select the period that is appropriate to your needs</p>
                                            <div className='px-2 bg-gray-200 w-64 h-10 flex items-center'>
                                                <div className='pl-4 text-sm font-medium'>Select duration</div>
                                                <img src={down} className='ml-auto' />
                                            </div>
                                        </div>
                                    </div>
                                    <div className='flex flex-col gap-2 py-2'>
                                        ...
                                        <div className='pl-1 flex flex-col gap-3'>
                                            <p className='text-sm text-gray-800 md:4/5 lg:w-3/4'>Please select a repayment schedule</p>
                                            <div className='px-2 bg-gray-200 w-64 h-10 flex items-center'>
                                                <div className='pl-4 text-sm font-medium'>Select a payment plan</div>
                                                <img src={down} className='ml-auto' />
                                            </div>
                                        </div>
                                    </div>
