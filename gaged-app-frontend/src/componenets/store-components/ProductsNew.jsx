...
function ProductsNew() {
  ...
  // const resetHandler = () => {
  // setProductDetails.productTitle("");
  // setProductDetails.shortDescription('');
  // setProductDetails.productDetails("");
  // setProductDetails.standardPrice("");
  // setProductDetails.discountedPrice("");
  // setProductDetails.discountedPrice("");
  // setProductDetails.costPrice("");
  // setProductDetails.productStockCount("");
  // setProductDetails.productSKU("");
  // setProductDetails.productImageTOne("");
  // setProductDetails.productImageTwo("");
  // setProductDetails.productImageThree("");
  // setProductDetails.category("");
  //
  // };

  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(createStoreProductAction());
                ...
                <div className="border-2 mt-5 lg:w-2/3 px-3 lg:px-6 pt-6 pb-10">
                  ...
                  <div className="grid grid-rows-1 gap-5 lg:gap-0 lg:grid-cols-3 mt-4">
                    <div className="flex">
                      ...
                      <input
                        name="standardPrice"
                        value={productDetails.standardPrice}
                  ...
                  <div className="mt-5 grid grid-rows-1 gap-5 lg:gap-0 lg:grid-cols-3">
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        value={productDetails.productStockCount}
                    ...
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        value={productDetails.productUnitCount}
                        placeholder="Product count"
                        className="border-2 lg:w-52 h-10 outline-none text-center"
                      />
                    </div>
