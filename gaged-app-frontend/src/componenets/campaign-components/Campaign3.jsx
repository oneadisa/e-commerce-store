    ...
    <div className="mx-auto">
      ...
      <div className="bg-magenta-blue h-full">
        <div className="block lg:flex lg:space-x-24">
          <ul
            className={
              "w-2/3 lg:w-32 lg:pl-4 min-h-screen lg:min-h-0 absolute transition duration-200 bg-magenta-blue text-Dark-grey lg:static flex flex-col text-lg font-medium lg:mt-10 lg:block" +
              (open === true ? " " : " hidden ")
            }
          >
