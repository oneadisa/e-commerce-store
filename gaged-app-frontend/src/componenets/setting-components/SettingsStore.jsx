            ...
            <div className="px-3 lg:px-7 pt-5 pb-8 md:pt-5 md:pb-20 mt-4 md:mt-5 md:mb-14 bg-white">
              ...
              <div className="my-5">
                ...
                <div className="flex flex-col gap-2 mt-10 md:mt-5">
                  ...
                  <div className="mt-10">
                    <button className="bg-Dark-blue text-white text-base font-semibold w-full md:w-1/3 lg:w-1/5 px-5 py-2 border-2 rounded-md hover:bg-white hover:text-Dark-blue">
                      Publish Store
                    </button>
                  </div>
                </div>
