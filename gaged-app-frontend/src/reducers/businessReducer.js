...
export const businessAllBusinessOrderedFromReducer = (state = { businessOrderedFrom: [] }, action) => {
  switch (action.type) {
...
export const businessNewBusinessOrderedFromReducer = (state = { businessOrderedFrom: {} }, action) => {
  switch (action.type) {
