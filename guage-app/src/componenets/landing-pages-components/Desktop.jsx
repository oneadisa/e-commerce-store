        ...
        <div className='flex justify-between items-center mx-auto py-4 md:px-10 lg:px-20 bg-light-blue'>
            ...
            <div className='flex md:gap-2 lg:gap-3 ml-auto' >
              ...
              className="form flex md:gap-2 lg:gap-3 ml-auto">
                <Link to="/userLogin" className='py-2 md:px-5 lg:px-7 border border-Dark-blue text-Dark-blue font-medium rounded hover:bg-Dark-blue hover:text-white'>Log in</Link>
                </form>
                <Link to="/signup" className='py-2 md:px-5 lg:px-7 border border-Dark-blue bg-Dark-blue text-white font-medium rounded hover:bg-white hover:text-Dark-blue'>Sign up</Link>
