                            ...
                            <div className='flex flex-col w-full gap-2'>
                                <div className='flex flex-col border-2'>
                                    ...
                                    <div className='flex border-t-2 justisfy-items-center text-center items-center'>
                                        <div className='flex flex-col gap-4 lg:gap-8 py-4 pb-4 lg:py-9 border-r w-full'>
                                            <h4 className='text-lg font-medium'>18%</h4>
                                            <p className='text-sm font-normal'>EQUITY</p>
                                        </div>
                                        <div className='flex flex-col gap-4 lg:gap-8 py-4 pb-4 lg:py-9 border-l w-full'>
                                ...
                                <div className='flex flex-col gap-4 mt-16 md:w-2/3 lg:w-5/12 '>
                                    ...
                                    <div className='flex justify-between my-12'>
                                        <button className='py-2 border-2 border-Dark-blue text-Dark-blue text-base
                                         font-medium rounded w-1/3 lg:w-1/4 hover:bg-Dark-blue hover:text-white flex gap-3 md:gap-6'>
                                         <img src={left} alt=""/>
                                        <div>
                                            Back
                                        </div>
...
export default CampaignsSecond
