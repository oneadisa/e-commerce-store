      ...
      <>
        ...
        <div className="py-3 pb-10 px-3 md:px-10 flex flex-col lg:flex-row gap-10 md:gap-14 mx-auto">
          ...
          <div className="flex flex-col justify-center">
            <h1 className='text-2xl md:text-2xl lg:text-3xl font-semibold font-poppins'>Select your account type</h1>
            ...
            <p className='text-base md:text-lg leading-6 md:leading-7 mt-28 font-medium'>
              Already have an account? <a className='text-blue-600'>Sign In </a>
            </p>
          </div>
        </div>
      </>
